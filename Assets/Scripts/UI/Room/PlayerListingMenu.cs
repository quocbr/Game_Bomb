...
public class PlayerListingMenu : MonoBehaviourPunCallbacks
{
    ...
    {
        _roomsCanvas.CurrenRoomCanvas.LeaveRoomMenu.OnClick_LeaveRoom();
    }
    ...
    public void OnClick_ReadyUp()
    {
        ...
        {
            SetReadyUp(!_ready);
            base.photonView.RPC("RPC_ChangerReadyState", RpcTarget.MasterClient,PhotonNetwork.LocalPlayer,_ready);
        }
    }
    [PunRPC]
    private void RPC_ChangerReadyState(Player player, bool ready)
    {
        int index = _listings.FindIndex(x => x.Player == player);
